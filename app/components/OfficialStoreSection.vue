  ...
  <section class="bg-white" v-if="hasAnyProduct">
    <div class="max-w-screen-2xl mx-auto px-2 sm:px-4 md:px-11 py-12 md:py-10">
      ...
      <div v-if="loading" class="text-center py-10">
        ...
        ></div>
        <p class="mt-4 text-gray-600">Memuat Official Store...</p>
      </div>
...
const nextLink = computed(() => {
  return `/products/official-store?subgroup=${activeSubGroupId.value || ""}`;
});
